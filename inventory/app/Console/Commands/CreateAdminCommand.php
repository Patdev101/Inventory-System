...
{
    protected $signature = 'inventory:create-admin';
    ...
    {
        $this->info('Create the first admin account for this Inventory install.');
        $this->newLine();
        ...
        $this->comment('Sign in at /login. This account can now create manager and staff accounts from User Management.');
