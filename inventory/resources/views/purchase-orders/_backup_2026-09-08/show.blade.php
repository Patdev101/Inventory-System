                    ...
                    <tbody>
                        ...
                        @foreach ($purchaseOrder->items as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($item->productUnit?->conversion_factor)
                                        <div class="unit-conversion">
                                            {{ $item->productUnit->conversion_factor }} x base unit
                                        </div>
                                    @endif
                                </td>
                                ...
                                <td class="number-cell">
                                    {{ rtrim(rtrim(number_format((float) $item->remaining_quantity, 4), '0'), '.') }}
                                </td>
            ...
            <div class="summary" style="padding:0 20px 20px;">
                ...
                <div class="summary-box">
                    ...
                    <div class="summary-row">
                        ...
                        <strong>
                            {{ rtrim(rtrim(number_format($purchaseOrder->items->sum('quantity_ordered'), 4), '0'), '.') }}
                        </strong>
                    </div>
                ...
                <div class="approval-box">
                    ...
                    @if ($purchaseOrder->approved_at)
                        <span style="color:#64748b;">
                            on {{ $purchaseOrder->approved_at->format('d/m/Y H:i') }}
                        </span>
                    @endif
                ...
                <div class="receipt-card">
                    ...
                    <div class="receipt-card-header">
                        ...
                        <span class="receipt-total-qty">
                            {{ rtrim(rtrim(number_format($receipt->total_quantity, 4), '0'), '.') }} units
                        </span>
                            ...
                            <tbody>
                                ...
                                @foreach ($receipt->items as $receiptItem)
                                    ...
                                    <tr>
                                        ...
                                        <td class="number-cell">
                                            {{ rtrim(rtrim(number_format((float) $receiptItem->quantity_received, 4), '0'), '.') }}
                                        </td>
