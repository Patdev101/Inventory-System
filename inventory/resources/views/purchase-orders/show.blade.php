...
<div class="po-show-page">
    ...
    <div class="po-section">
        ...
        <div class="po-section-header">
            ...
            <p>
                Supplier, receiving location and order information.
            </p>
    ...
    <div class="po-section">
        ...
        <div class="po-section-body">
            ...
            <div class="actions">
                ...
                {{-- =================================================
                     PENDING APPROVAL
                     Opens modals instead of submitting directly, so a
                     real rejection reason / optional approval note can
                     be captured.
                ================================================== --}}
                ...
                @if (
                    ...
                    <a href="{{ route('purchase-orders.receive.form', $purchaseOrder) }}" class="po-btn po-btn-success">
                        Receive Goods
                    </a>
